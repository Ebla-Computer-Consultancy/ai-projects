...
SETTINGS_ACCOUNT_KEY=os.getenv("SETTINGS_ACCOUNT_KEY")
SETTINGS_ACCOUNT_HOST=os.getenv("SETTINGS_ACCOUNT_HOST")
SETTINGS_COSMOS_DATABASE=os.getenv("SETTINGS_COSMOS_DATABASE")
SETTINGS_COSMOS_CONTAINER=os.getenv("SETTINGS_COSMOS_CONTAINER")
