...
class CustomSettings:
    def __init__(self, temperature=None, tools=None, max_tokens=None, top_p=None, max_history_length=None, display_in_chat=None, preserve_first_message=None):
        ...
        self.preserve_first_message = preserve_first_message if preserve_first_message is not None else False
