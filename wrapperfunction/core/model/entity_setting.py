...
class ChatbotSetting:
    def __init__(
        self, name, index_name, system_message,enable_history,apply_sentiment, greeting_message,preserve_first_message,examples=[], custom_settings=None, display_in_chat=True
    ):  # Default to None
        self.name = name
