...
from wrapperfunction.chatbot.model.chat_message import Roles,Message_Type
...
class MessageEntity:
    def __init__(self, content: str, conversation_id: str, role: Roles, context: str, type:Message_Type=Message_Type.Message.value):
    ...
    def to_dict(self):
        return {
            ...
            MessagePropertyName.Message_Type.value: self.type            
        }
